      ...
      <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h3 class="modal-title" style="display: inline !important;"><b>VIEW RESERVATION DETAILS (Overnight)</b></h3>
                </div>
                <div class="modal-body">
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="input-group col-md-12">
                                    <span class="input-group-addon" id="basic-addon5">Room Accomodation</span >
                                    <input type="number" name="#" class="form-control disabled" id="mobileNum" aria-label="Publisher" aria-describedby="basic-addon5" value="" disabled>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="input-group col-md-12">
                                    <span class="input-group-addon" id="basic-addon3">Room No.</span >
                                    <input type="text" name="#" class="form-control disabled" id="email" aria-label="Copyright" aria-describedby="basic-addon3" value="" disabled>
                                </div>
                            </div>
                        </div><br>
