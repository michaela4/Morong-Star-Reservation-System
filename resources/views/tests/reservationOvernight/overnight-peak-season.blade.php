	...
	@section('content_header')
	    <h1>OVERNIGHT STAY - Peak Season Promo</h1><hr>
	@stop
				...
				<div class="box-body">
              		<div class="row">
						<form method="POST" action="/add-customer">
			                    ...
			                    <thead>
			                        ...
			                        <tr>
			                        	<th class="text-center">
			                        		Overnight Accomodation/SET A <br>
			                        		AC Room <br>
			                        		Dinner (Buffet, 1st meal) <br>
			                        		Breakfast (Plated)<br>
			                        		Lunch (Buffet)<br>
			                        		Zip Line Ride <br>
			                        		Kayaking <br>
			                ...
			                <center>
			                        		Peak Season Promo is available on Friday and Saturdays only.  VAT Inclusive.
			                        	</center>
			            </form>
			        </div>
			    </div>
