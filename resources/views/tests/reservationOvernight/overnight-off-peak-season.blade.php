@extends('adminlte::page')
	...
	@section('content_header')
	    <h1>OVERNIGHT STAY - Off-Peak Season</h1><hr>
              		...
              		<div class="row">
						<form method="POST" action="/add-customer">
							...
							<table class="table table-bordered table-hover" cellspacing="0" width="75%">
			                 ...
			                 <center>
			                     Inexclusive of beach entrance, access to swimming pool and use of adventure park plus free breakfast
			                 </center>
			            </form>
			        </div>
			    </div>
