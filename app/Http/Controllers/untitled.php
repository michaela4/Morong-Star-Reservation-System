								...
								<table class="table table-bordered table-hover" cellspacing="0" width="75%">
					                    ...
					                    @foreach($day_trip_promos as $day_trip_promo)
					                        <tr>
					                        	...
					                        	<th >
					                        		<center>
					                        			<input style="margin-bottom:35px;" type="number" class="form-control" placeholder="0">
					                        		</center>
					                        	</th>
					                        	<th class="col-md-2">
...
<form method="POST" action="/delete/{{$reservation->customer->id}}">
                                {{ csrf_field() }}
