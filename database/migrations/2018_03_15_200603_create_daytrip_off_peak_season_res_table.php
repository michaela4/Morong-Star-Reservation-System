...
class CreateDaytripOffPeakSeasonResTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('daytrip_off_peak_season_res', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('daytrip_off_peak_season_res');
    }
}
